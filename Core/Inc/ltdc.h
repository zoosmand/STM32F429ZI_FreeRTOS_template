...
#define LCD_CLK_Pin_Pos           GPIO_PIN_7_Pos
#define LCD_CLK_Pin_Mask          GPIO_PIN_7_Mask
// PF10
#define LCD_DE_Pin                GPIO_PIN_10
#define LCD_DE_Pin_Pos            GPIO_PIN_10_Pos
#define LCD_DE_Pin_Mask           GPIO_PIN_10_Mask
// PD11
#define LCD_TE_Pin                GPIO_PIN_11
#define LCD_TE_Pin_Pos            GPIO_PIN_11_Pos
#define LCD_TE_Pin_Mask           GPIO_PIN_11_Mask
// PD12
#define LCD_RDX_Pin               GPIO_PIN_12
#define LCD_RDX_Pin_Pos           GPIO_PIN_12_Pos
#define LCD_RDX_Pin_Mask          GPIO_PIN_12_Mask
// PD13
#define LCD_WRX_Pin               GPIO_PIN_13
#define LCD_WRX_Pin_Pos           GPIO_PIN_13_Pos
#define LCD_WRX_Pin_Mask          GPIO_PIN_13_Mask
#define LCD_WRX_Port              GPIOD
// PC2
#define LCD_CS_Pin                GPIO_PIN_2
#define LCD_CS_Pin_Pos            GPIO_PIN_2_Pos
#define LCD_CS_Pin_Mask           GPIO_PIN_2_Mask
...
/* Private macro -------------------------------------------------------------*/
#define LCD_CS_H                    PIN_H(LCD_CS_Port, LCD_CS_Pin_Pos)
#define LCD_CS_L                    PIN_L(LCD_CS_Port, LCD_CS_Pin_Pos)
#define LCD_WRX_H                   PIN_H(LCD_WRX_Port, GPIO_BSRR_BS13_Pos)
#define LCD_WRX_L                   PIN_L(LCD_WRX_Port, GPIO_BSRR_BS13_Pos)
